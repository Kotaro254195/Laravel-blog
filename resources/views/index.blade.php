                        ...
                        <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
                            <div class="heading">
                                <h4 class="h1 heading-title">
                                    <a href="{{ route("category.single",["id"=>$laravel->id])}}">{{$laravel->name}}</a>
                                </h4>
                                <div class="heading-line">
                                    <span class="short-line"></span>
                                    <span class="long-line"></span>
                ...
                <div class="offers">
                    <div class="row">
                        <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
                            <div class="heading">
                                <h4 class="h1 heading-title">
                                    <a href="{{ route("category.single",["id"=>$php->id])}}">{{$php->name}}</a>
                                </h4>
                                <div class="heading-line">
                                    <span class="short-line"></span>
                                    <span class="long-line"></span>
...
<script src="{{asset('pp/js/crum-mega-menu.js')}}"></script>
